			...
			<div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,380px)_1fr] lg:items-center">
				...
				<div>
					...
					<div className="mt-4 max-w-2xl space-y-4 font-body text-base leading-relaxed text-ink/85 dark:text-kraft-200/85">
						<p>
							I’m Deanna Pursley, a graphic designer who enjoys
							turning your ideas into clear, memorable visual
							systems. My work spans identity, campaign design,
							editorial, illustration, and responsive digital
							experiences.
						</p>
						<p>
							Skillbilly Art & Design grew from my country roots.
							It reflects who I am and the hardworking, everyday
							people I design for. Being country doesn’t limit my
							creativity or capability—it shapes my honest,
							resourceful, and grounded approach. As a
							professionally educated graphic designer, I created
							a brand that feels genuine, approachable, and full
							of personality. I believe great design should be
							accessible without requiring a luxury budget.
              </p><p>
							Skillbilly represents polished, thoughtful work
							built on strong ideas, clear hierarchy, consistent
							choices, and purposeful details that make every
							piece feel like it truly belongs.
						</p>
					</div>
					...
					<dl className="mt-7 grid grid-cols-2 gap-3 sm:grid-cols-4">
						{facts.map((fact) => (
							...
							>
								...
								<dd className="font-display text-base text-barn">
									{fact.value}
								</dd>
							</div>
						))}
